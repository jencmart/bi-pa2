...
public:
   ...
   InputOutput()
   {
      ...
      start_color();
      init_pair('n', COLOR_WHITE, COLOR_WHITE); // NEUTRAL HILL
      init_pair('p', COLOR_GREEN, COLOR_GREEN);  //GREEN HILL
      init_pair('e', COLOR_RED, COLOR_RED);    // RED HILL
      init_pair('f', COLOR_BLUE, COLOR_BLUE);  // BLUE HILL
      init_pair('g', COLOR_MAGENTA, COLOR_MAGENTA);  // MAGENTA HILL
      init_pair('h', COLOR_CYAN, COLOR_CYAN);  // MAGENTA HILL
