...
public:
   ...
   InputOutput()
   {
      ...
      start_color();
      init_pair(((short)'n'  - 70 ), COLOR_WHITE, COLOR_WHITE); // NEUTRAL HILL
      init_pair( ((short)'p'  - 70 ) , COLOR_GREEN, COLOR_GREEN);  //GREEN HILL
      init_pair(((short)'e'  - 70 ), COLOR_RED, COLOR_RED);    // RED HILL
      init_pair(((short)'f'  - 70 ), COLOR_BLUE, COLOR_BLUE);  // BLUE HILL
      init_pair(((short)'g'  - 70 ), COLOR_MAGENTA, COLOR_MAGENTA);  // MAGENTA HILL
      init_pair(((short)'h'  - 70 ), COLOR_CYAN, COLOR_CYAN);  // MAGENTA HILL
